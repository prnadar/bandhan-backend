...
async def get_daily_matches(
    ...
    """Returns today's curated matches. Generated by Celery at 05:30 IST."""
    ...
    # Next refresh at 06:00 IST tomorrow
    next_refresh = f"{date.today().isoformat()}T00:30:00Z"  # UTC = 06:00 IST
